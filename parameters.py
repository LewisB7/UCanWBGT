...
tile_number = 8 # which tile to use (note: select 8 rather than 9 for the urban area since if H=0 roof rather than ground properties would be used). 0: Broad Leaf Tree, 1: Needle Leaf Tree, 2: C3 Grass, 3: C4 Grass, 4: Shrub, 5: Inland Water, 6: Bare Soil, 7: Ice, 8: Urban Canyon, 9: Urban Roof
