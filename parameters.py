...
Twb_method = "NEWT_isobaric" # whether to use the `Stull` (2011), `NEWT_isobaric`, or `NEWT_adiabatic` Twb method
...
tile_number = 8 # which tile to use 0: Broad Leaf Tree, 1: Needle Leaf Tree, 2: C3 Grass, 3: C4 Grass, 4: Shrub, 5: Inland Water, 6: Bare Soil, 7: Ice, 8: Urban Canyon, 9: Urban Roof
